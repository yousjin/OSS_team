const schedule = function (rtm, text, channel) {
  ...
  var arr = ["8/4", "8/22", "9/1", "9/2", "9/3", "9/4", "9/5", "9/6", "9/7", "10/15", "10/19", "10/20", "10/21", "10/27", "11/3", "11/24", "12/21", "12/23"]
  ...
  if (regex.test(text)){
    ...
    if (index == -1){
      ...
      for (var i=0; i< arrIndex[index].length; i++){
        var contents = haksa[arrIndex[index][i]].toString().split(' : ');
